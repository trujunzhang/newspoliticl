...
class UserCollectionsPopover extends Component {
    ...
    renderCollectionListBody(folders) {
        return (
            <ul className="collections-popover--collections popover--scrollable-list">
                <li>
                    <a className="collections-popover--collection popover--scrollable-list--element" href="https://www.producthunt.com/#">my favorite<span className="collections-popover--collection--icon v-collect"></span>
                    </a>
                </li>
                <li>
                    <a className="collections-popover--collection popover--scrollable-list--element" href="https://www.producthunt.com/#">Save for later
        ...
        return (
            <div>
                <div class="popover--header">
                    <h3 class="popover--header--title">Add to Collection</h3>
                    <a class="popover--header--icon">
                        <span>
                ...
                <div class="popover--message">
                    ...
                    <button class="button_2I1re mediumSize_10tzU secondaryBoldText_1PBCf secondaryText_PM80d simpleVariant_1Nl54">
                        <div class="buttonContainer_wTYxi">Login to Continue</div>
                    </button>
                </div>
            </div>
        )
    ...
    renderAddNewForm() {
        return (
            <form id="newCollectionForm" className="collections-popover--form" _lpchecked="1">
                <input autoFocus type="text" className="collections-popover--form--field input collections-input" value={this.state.value} onChange={this.onChange} placeholder="Collection name" ref="newCollectionInput"/>
    ...
    rendAddNewButton() {
        return (
            <a id="addNewCollectionButton" onClick={this.onAddNewClick} className="collections-popover--form-trigger" href="https://www.producthunt.com/#">Add New</a>
        )
    }
