...
class UsersMenu extends Component {
    ...
    render() {
        ...
        const avatar = avatarUrl ? <img height="32" width="32" src={avatarUrl}/> : <img width="32" height="32"></img>;
          ...
          <div className="account_FReak">
            ...
            <span>
              <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                <path d="M8,10 L8,4 L6,4 L6,10 L0,10 L0,12 L6,12 L6,18 L8,18 L8,12 L14,12 L14,10 L8,10 Z"
                      transform="translate(0 -4)" fill="#999"></path>
              </svg>
            </span>
              </a>
            ...
            <span className="secondaryText_PM80d default_tBeAo base_3CbW2">
              ...
              <a className="userMenu_3flqi" id="user-menu" onClick={this.popoverUserMenus.bind(this)}>
                    <span className="user-image" ref="userProfile">
