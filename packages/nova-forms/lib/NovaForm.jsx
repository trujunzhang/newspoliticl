...
class NovaForm extends Component {
    ...
    // render errors
    renderErrors() {
        return <div className="form-errors">{this.state.errors.map(message => <Flash key={message}
                                                                                     message={message}/>)}</div>
    }
          ...
          <div className={"document-" + this.getFormType()}>
              ...
              >
                  ...
                  {this.props.cancelCallback ?
                    <a className="form-cancel" onClick={this.props.cancelCallback}><FormattedMessage id="forms.cancel"/></a> : null}
              </Formsy.Form>
          </div>
        )
    }
